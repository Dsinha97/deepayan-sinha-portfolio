 ...
 * the proof strip, the About paragraphs, and the trailing tools row. The
 * experience, education, certification, skills and recognition data now
 * lives in `src/content/*` — see docs/wiki/site-architecture.md.
 */
